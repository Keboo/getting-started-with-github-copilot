...
| **📋 Planning Mode**      | Breaks down complex or multi-step requests into structured, trackable tasks with markdown and JSON plans before execution.                           | Complex tasks requiring multiple steps, when you want visibility into the plan before execution begins           |
